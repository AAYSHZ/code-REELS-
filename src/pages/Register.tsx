      ...
      <FadeContent className="w-full max-w-sm space-y-8 relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold">
            <BlurText text="Create Account" className="gradient-text" delay={0.2} />
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            <BlurText text="Join CodeReels" delay={0.4} />
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label>Name</Label>
            <Input value={name} onChange={e => setName(e.target.value)} placeholder="Your name" className="bg-muted/30 border-border backdrop-blur-sm" />
          </div>
          <div className="space-y-2">
            <Label>Email</Label>
          ...
          <div className="space-y-2">
            ...
            <Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Min 6 characters" className="bg-muted/30 border-border backdrop-blur-sm" />
          </div>
          <Magnet strength={0.2}>
