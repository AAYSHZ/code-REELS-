    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Join CodeReels</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label>Name</Label>
            <Input value={name} onChange={e => setName(e.target.value)} placeholder="Your name" className="bg-muted/30 border-border" />
          </div>
          <div className="space-y-2">
            <Label>Email</Label>
          ...
          <div className="space-y-2">
            ...
            <Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Min 6 characters" className="bg-muted/30 border-border" />
          </div>
