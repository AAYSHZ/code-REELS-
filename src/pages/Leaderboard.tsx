          ...
          <TabsContent key={t.value} value={t.value}>
            {loading ? (
              ...
              <div className="space-y-2">
                {users.map((u, i) => (
                  <Link key={u.id} to={`/profile/${u.user_id}`} className="flex items-center gap-3 glass rounded-xl p-3 hover:border-primary/30 transition-colors">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-secondary">{u[t.sort]}</p>
